...
export function LoginPage() {
  ...
  const legendCls = "text-xs text-gray-400 px-1 group-focus-within/field:text-blue-400 transition-colors py-4";
  const inputCls = "w-full bg-transparent text-lg text-gray-100 focus:outline-none placeholder-gray-600 py-2 pl-1 font-['JetBrains_Mono']";
