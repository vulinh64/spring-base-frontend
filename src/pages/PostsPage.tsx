...
export function PostsPage() {
  ...
  const { data, isLoading, error } = usePosts({ page, size, sort: ["createdDateTime,desc", "updatedDateTime,desc"] });
    ...
    <div>
      ...
      {data && (
        <>
          ...
          <Pagination page={page} totalPages={data.page.totalPages} onPageChange={setPage} size={size} onSizeChange={setSize} sizeLabel="Posts per page:" />
        </>
      )}
    </div>
  );
